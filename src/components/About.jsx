...
export default function About() {
	...
	return (
		<section id="about" className="pb-5">
			...
			<p className="mb-4"><span className="sharpie-highlight">Structure shines best when shared</span>. I enjoy creating clear, actionable plans and sharing them with my team. They help us all crowd source the best ideas and to accomplish our top priorities. <span className="sharpie-highlight">Communication</span> has grown into one of <span className="sharpie-highlight">the most important features</span> of my everyday work.</p>
			<p className="mb-4">I work as a web software developer, with <span className="sharpie-highlight">fullstack</span> capabilities in various applications</p>
