...
export default function About() {
	...
	return (
		<section id="about" className="pb-5">
			...
			<p className="text-center my-3"><span className="sharpie-highlight"><a href="#lodge" className="text-redirect">Lodge: React Web App for travel booking <FaLink /></a></span></p>
			<p>It is currently live with some mock locations. It could actually be used for booking, but without payment. This app has a Node backend. I previously created an <span className="sharpie-highlight"><a href="#banking" className="text-redirect">Online Banking App with a Java Backend <FaLink /></a></span> (using Spring framework).</p>
